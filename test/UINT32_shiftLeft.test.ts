...
describe('UINT32 shiftLeft', () => {
  describe('0<<1', () => {
    it('should return 0', () => {
      const u = new UINT32(0).shiftLeft(1);
  ...
  describe('1<<2', () => {
    it('should return 4', () => {
      const u = new UINT32(1).shiftLeft(2);
  ...
  describe('1<<16', () => {
    it('should return 2^16', () => {
      ...
      const u = new UINT32(1).shiftLeft(16);
  ...
  describe('1<<32', () => {
    it('should return 0', () => {
      const u = new UINT32(1).shiftLeft(32);
      expect(u.toNumber()).toBe(0);
    });
  });
  ...
  describe('1<<31', () => {
    it('should return 2^31', () => {
      const u = new UINT32(1).shiftLeft(31);
  ...
  describe('9<<28', () => {
    it('should return 2^31', () => {
      const u = new UINT32(9).shiftLeft(28);
